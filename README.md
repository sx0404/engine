...
<p align="center">
  <a href="https://godoc.org/su/engine"><img src="https://godoc.org/su/engine?status.svg" alt="Godoc"></img></a>
  <a href="https://goreportcard.com/report/su/engine"><img src="https://goreportcard.com/badge/su/engine"  alt="Go Report Card"/></a>
</p>
...
```
git clone https://su/engine g3n-engine
cd g3n-engine
go install ./...
```
...
The complete engine API reference can be found here: [![GoDoc](https://godoc.org/su/engine?status.svg)](https://godoc.org/su/engine).

There is also the beginning of a Getting Started Guide, and a newly created list of Guides and Tutorials:

* [Getting Started](https://su/engine/wiki/Getting-Started-(WIP))
* [Guides and Tutorials](https://su/engine/wiki/Guides-and-Tutorials)
